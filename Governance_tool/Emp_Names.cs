...
{
    internal class Emp_Names
    {
        public void searchby_l1_handler_list(DataTable dta)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select distinct L1_Handler from dbo.vw_governance_tracker_transactional_dotnet order by L1_Handler";
